...
export interface UserInteraction {
   ...
   * @returns A promise that resolves to the confirm result wrapper or Error
   * @throws Error
   */
  confirm?: (config: ConfirmConfig) => Promise<Result<ConfirmResult, Error>>;
  /**
   * Shows a single selection list
   * @param config single selection config
   * @returns A promise that resolves to the single select result wrapper or Error
   * @throws Error
   */
  selectOption: (config: SingleSelectConfig) => Promise<Result<SingleSelectResult, Error>>;
  /**
   * Shows a multiple selection list
   * @param config multiple selection config
   * @returns A promise that resolves to the multiple select result wrapper or Error
   * @throws Error
   */
  selectOptions: (config: MultiSelectConfig) => Promise<Result<MultiSelectResult, Error>>;
  /**
   * Opens an input box to ask the user for input.
   * @param config text input config
   * @returns A promise that resolves to the text input result wrapper or Error
   * @throws Error
   */
  inputText: (config: InputTextConfig) => Promise<Result<InputTextResult, Error>>;
  /**
   * Shows a file open dialog to the user which allows to select a single file
   * @param config file selector config
   * @returns A promise that resolves to the file selector result wrapper or Error
   * @throws Error
   */
  selectFile: (config: SelectFileConfig) => Promise<Result<SelectFileResult, Error>>;
  /**
   * Shows a file open dialog to the user which allows to select multiple files
   * @param config multiple files selector config
   * @returns A promise that resolves to the multiple files selector result wrapper or Error
   * @throws Error
   */
  selectFiles: (config: SelectFilesConfig) => Promise<Result<SelectFilesResult, Error>>;
  /**
   * Shows a file open dialog to the user which allows to select a folder
   * @param config folder selector config
   * @returns A promise that resolves to the folder selector result wrapper or Error
   * @throws Error
   */
  selectFolder: (config: SelectFolderConfig) => Promise<Result<SelectFolderResult, Error>>;
   ...
   */
  openUrl(link: string): Promise<Result<boolean, Error>>;
  /**
   ...
   */
  reload?(): Promise<Result<boolean, Error>>;
   ...
   * @returns A promise indicating if open was successful.
   */
  openFile?(filePath: string): Promise<Result<boolean, Error>>;
...
//   }): Promise<Result<string, Error>>;
   ...
   * @returns A promise that resolves to the local file path or the value entered by user or Error
   * @throws Error
   */
  selectFileOrInput?(
