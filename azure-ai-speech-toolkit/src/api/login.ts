...
export interface M365TokenProvider {
   ...
   */
  getAccessToken(tokenRequest: TokenRequest): Promise<Result<string, Error>>;
  /**
   ...
   * @param tokenRequest permission scopes or show user interactive UX
   */
  getJsonObject(tokenRequest: TokenRequest): Promise<Result<Record<string, unknown>, Error>>;
  /**
   * Get user login status
   * @param tokenRequest permission scopes or show user interactive UX
   */
  getStatus(tokenRequest: TokenRequest): Promise<Result<LoginStatus, Error>>;
  /**
   * Add update account info callback
   * @param name callback name
   ...
   * @param name callback name
   */
  removeStatusChangeMap(name: string): Promise<Result<boolean, Error>>;
}
...
export abstract class BasicLogin {
  ...
  abstract getStatus(tokenRequest: TokenRequest): Promise<Result<LoginStatus, Error>>;
