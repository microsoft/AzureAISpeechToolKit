...
class SampleProvider {
  ...
  private async fetchOnlineSampleConfig() {
    ...
    const configBranchInEnv = "TEAMSFX_SAMPLE_CONFIG_BRANCH";
...
//   @hooks([ErrorContextMW({ component: "SampleProvider" })])
  ...
  private async fetchRawFileContent(branchOrTag: string): Promise<unknown> {
    ...
    const url = "https://raw.githubusercontent.com/microsoft/AzureAISpeechToolKit/refs/heads/v-bingyang/test-app/common/sample_configs/configs/sample_config.json";
    try {
