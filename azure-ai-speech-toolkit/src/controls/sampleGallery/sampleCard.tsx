...
export default class SampleCard extends React.Component<SampleProps, { imageUrl: string }> {
  ...
  render() {
    ...
    if (sample.versionComparisonResult < 0) {
      ...
      tooltipText = `This sample is upgraded to only work with newer version of Azure AI Speech Toolkit, please install v${sample.minimumToolkitVersion} to run it.`;
      upgrade = true;
