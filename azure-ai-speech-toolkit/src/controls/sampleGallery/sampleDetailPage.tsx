...
export default class SampleDetailPage extends React.Component<SampleProps, SampleDetailState> {
  ...
  private getBanner = () => {
    ...
    if (this.props.sample.versionComparisonResult < 0) {
      message = `This sample is upgraded to only work with newer version of Azure AI Speech Toolkit, please install v${this.props.sample.minimumToolkitVersion} to run it.`;
    }
    return (
      <div className="upgrade-banner">
        ...
        {this.props.sample.versionComparisonResult < 0 && (
          ...
          >
            Upgrade Azure AI Speech Toolkit
          </VSCodeButton>
        )}
      </div>
    );
